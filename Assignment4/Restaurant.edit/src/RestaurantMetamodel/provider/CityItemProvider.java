...
/**
 * This is the item provider adapter for a {@link RestaurantMetamodel.City} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addCapPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_City_cap_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_City_cap_feature", "_UI_City_type"),
				 RestaurantMetamodelPackage.Literals.CITY__CAP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RestaurantMetamodelPackage.Literals.CITY__REGION,
				 true,
				 false,
				 true,
				 null,
