...
/**
 * This is the item provider adapter for a {@link RestaurantMetamodel.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RestaurantMetamodelPackage.Literals.DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RestaurantMetamodelPackage.Literals.DIAGRAM__ELEMENTS);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(RestaurantMetamodelPackage.Literals.DIAGRAM__ELEMENTS,
				 RestaurantMetamodelFactory.eINSTANCE.createRestaurant()));

		newChildDescriptors.add
			(createChildParameter
				(RestaurantMetamodelPackage.Literals.DIAGRAM__ELEMENTS,
				 RestaurantMetamodelFactory.eINSTANCE.createCity()));
