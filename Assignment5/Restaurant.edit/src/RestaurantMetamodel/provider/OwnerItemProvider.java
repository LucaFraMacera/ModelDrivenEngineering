...
/**
 * This is the item provider adapter for a {@link RestaurantMetamodel.Owner} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OwnerItemProvider extends PersonItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Owner_vat_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Owner_vat_feature", "_UI_Owner_type"),
				 RestaurantMetamodelPackage.Literals.OWNER__VAT,
				 true,
				 false,
				 false,
