...
/**
 * This is the item provider adapter for a {@link RestaurantMetamodel.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumberOfSeatsPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RestaurantMetamodelPackage.Literals.TABLE__NUMBER,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Number Of Seats feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumberOfSeatsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_numberOfSeats_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_numberOfSeats_feature", "_UI_Table_type"),
				 RestaurantMetamodelPackage.Literals.TABLE__NUMBER_OF_SEATS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addMaterialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_material_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_material_feature", "_UI_Table_type"),
				 RestaurantMetamodelPackage.Literals.TABLE__MATERIAL,
				 true,
				 false,
				 false,
