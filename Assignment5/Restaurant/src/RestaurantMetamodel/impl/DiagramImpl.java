 ...
 * </p>
 * <ul>
 *   <li>{@link RestaurantMetamodel.impl.DiagramImpl#getElements <em>Elements</em>}</li>
 *   <li>{@link RestaurantMetamodel.impl.DiagramImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramImpl extends MinimalEObjectImpl.Container implements Diagram {
	...
	protected EClass eStaticClass() {
		return RestaurantMetamodelPackage.Literals.DIAGRAM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestaurantMetamodelPackage.DIAGRAM__NAME, oldName, name));
	}
